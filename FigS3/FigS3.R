...
setwd('D:/2025.10.4-NPH/0-Code-alive-1216/FigS3-1216')
...
Condition_com = read.xlsx("data_FigS3.xlsx", sheet = "Condition_AG", colNames = T, rowNames = T)
...
head(Distance)
# write.csv(Distance,"Phylo-Dist-1219.csv")
...
responding species and conditioning communities", y = "species-specific 
