...
setwd('D:/2025.10.4-NPH/0-Code-alive-1216/code-0108-R1/Fig.S2')
...
p <-
  ...
  labs(x = "Mean individual plant aboveground biomass 
of the conditioning species grown in monocultures (g)", y = "Mean individual plant aboveground biomass
of the conditioning species grown in mixtures (g)", tag = "(b)") +
