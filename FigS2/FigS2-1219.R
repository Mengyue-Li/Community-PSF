...
setwd('D:/2025.10.4-NPH/0-Code-alive-1216/FigS2-1216')
...
Condition_com = read.xlsx("data_FigS2_1218.xlsx", sheet = "Condition_AGraw", colNames = T, rowNames = T)
...
Responde_com = read.xlsx("data_FigS2_1218.xlsx", sheet = "Respond_AG", colNames = T, rowNames = T)
...
head(Distance)
# write.csv(Distance,"Phylo-Dist-1218.csv")
...
### Step 3: lm model   
#--------------------------------------
data0 = read.xlsx("data_FigS2_1218.xlsx", sheet = "species_specific_PSF", colNames = T, rowNames = T); data0[1:6,1:20]
...
data_ALL= read.xlsx("data_FigS2_1218.xlsx", sheet = "all_species" )    
data_ALL[1:6,1:4]
