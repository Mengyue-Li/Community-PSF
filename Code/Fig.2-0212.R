...
taxMod_with_guilds <-read_excel("data_Fig.2.xlsx",sheet=5);taxMod_with_guilds<- as.data.frame(taxMod_with_guilds); rownames(taxMod_with_guilds) <- taxMod_with_guilds[,1] 
